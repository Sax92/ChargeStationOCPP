                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Profilo
                            <small>Gestisci i tuoi dati</small>
                        </h1>
                        <ol class="breadcrumb">
							<li>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-2">
                                        <img class="img-responsive" src="<?=$config['img']?>avatar.png"/>
                                    </div>
                                    <div class="col-lg-10">
                                        ...
                                        <table id="profileUser" class="table table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?=$_SESSION['user']['data_nascita']?></td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td><?=$_SESSION['user']['email']?></td>
                                        ...
                                        <div class="form-group" id="editUser">
                                            ...
                                            <input class="form-control" id="nomeU" placeholder="<?=$_SESSION['user']['nome']?>" disabled="" type="text">
                                        </div>
                                    </div>
                                </div>
                            </div>
